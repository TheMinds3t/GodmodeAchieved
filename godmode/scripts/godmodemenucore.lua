    ...
    function dssmod.getInput(pnum)
        ...
        if not game:IsPaused() then
            ...
            menu.confirm = SafeKeyboardTriggered(Keyboard.KEY_ENTER, indx) or
                SafeKeyboardTriggered(Keyboard.KEY_ENTER, indx) or
    ...
    local function InitializeMenuCore()
        ...
        function dssmenu.GetDefaultMenuSprites()
            if not dssmenu.MenuSprites then
                ...
                dssmenu.MenuSprites.Back:Load("godmode/gfx/ui/deadseascrolls/menu_back.anm2", true)
                dssmenu.MenuSprites.Face:Load("godmode/gfx/ui/deadseascrolls/menu_face.anm2", true)
                dssmenu.MenuSprites.Mask:Load("godmode/gfx/ui/deadseascrolls/menu_mask.anm2", true)
                dssmenu.MenuSprites.Border:Load("godmode/gfx/ui/deadseascrolls/menu_border.anm2", true)
                dssmenu.MenuSprites.Font:Load("godmode/gfx/ui/deadseascrolls/menu_font.anm2", true)
                dssmenu.MenuSprites.Shadow:Load("godmode/gfx/ui/deadseascrolls/menu_shadow.anm2", true)
                dssmenu.MenuSprites.Symbols:Load("godmode/gfx/ui/deadseascrolls/menu_symbols.anm2", true)
            end
        ...
        function dssmenu.GetDefaultPanelSprites(panelType)
            if panelType == "main" then
                if not dssmenu.MenuSpritesMain then
                    ...
                    for k, v in pairs(spritePaths) do
                        local sprite = Sprite()
                        sprite:Load("godmode/gfx/ui/deadseascrolls/menu_main.anm2", false)
            ...
            elseif panelType == "tooltip" then
                if not dssmenu.MenuSpritesTooltip then
                    ...
                    for k, v in pairs(spritePaths) do
                        local sprite = Sprite()
                        sprite:Load("godmode/gfx/ui/deadseascrolls/menu_tooltip.anm2", false)
                        sprite:ReplaceSpritesheet(0, v)
                        sprite:LoadGraphics()
