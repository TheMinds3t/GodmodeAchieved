...
item.eid_description = "↑ +2 Golden Hearts #↑ +1 Soul Heart#↑ +15% Gilded chance"
item.eid_transforms = GODMODE.util.eid_transforms.ANGEL
item.encyc_entry = {
	{ -- Effects
		{str = "Effects", fsize = 2, clr = 3, halign = 0},
		{str = "When used, grants 2 golden hearts and 1 soul heart, and +15% Gilded chance (decaying, flat percent to convert basic pickups into their golden variants)."},
	},
}
