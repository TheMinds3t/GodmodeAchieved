local item = include("godmode.scripts.definitions.items.purity_vessel_base")
item.instance = GODMODE.registry.items.vessel_of_purity_2
item.next_instance = GODMODE.registry.items.vessel_of_purity_3
