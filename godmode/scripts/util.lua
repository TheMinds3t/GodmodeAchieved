...
util.stat_scale = {
	["damage"] = function(player) 
		return math.min(util.stat_dist["damage"],math.max(0,(player.Damage - 3.5) * 2.0)) end,
...
util.keyboard_enum_names = function()
	return GODMODE.options.dssmod.inputButtonNames
end
