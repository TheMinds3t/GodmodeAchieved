...
monster.npc_init = function(self, ent)
    if GODMODE.room:GetType() == RoomType.ROOM_BOSS and GODMODE.level:GetStage() == LevelStage.STAGE5 and GODMODE.level:GetStageType() == StageType.STAGETYPE_ORIGINAL then 
        music_flag = true
    end
end
