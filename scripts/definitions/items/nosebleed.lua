local item = {}
item.instance = GODMODE.registry.items.nosebleed
item.eid_description = "Temporary x1.5 Damage boost that leaves after 12 seconds each room"
item.encyc_entry = {
	{ -- Effects
		{str = "Effects", fsize = 2, clr = 3, halign = 0},
		{str = "Grants a 1.5x damage multiplier on entering a room, gradually fading over the course of 12 seconds."},
	},
}
