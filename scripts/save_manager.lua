...
save_manager.init = function() -- force functions to be loaded first
    ...
    GODMODE.log("Save manager fully initialized (GODMODE.save_manager = ("..tostring(GODMODE.save_manager).."))", true)
    save_manager.load()
    return true 
end
